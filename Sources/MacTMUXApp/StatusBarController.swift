...
final class StatusBarController: NSObject, NSPopoverDelegate {
    ...
    private var showsSessionCount: Bool {
        guard UserDefaults.standard.object(forKey: "showMenuBarSessionCount") != nil else {
            return true
        }
        return UserDefaults.standard.bool(forKey: "showMenuBarSessionCount")
    }
    ...
    private func updateStatusIcon(sessionCount: Int) {
        ...
        if StatusBarBadgeFormatter.badgeText(
    ...
    private func updatePopoverSizeIfNeeded() {
